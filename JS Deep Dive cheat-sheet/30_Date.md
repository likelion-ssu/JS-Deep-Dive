...
#### 4️⃣ `new Date(year, month[, day, hour, minute, second, milisecond])`
...
### ▶️ `Date.prototype.toLocaleString`
...
<details>
<summary><b>💻 현재 날짜와 시간을 초 단위로 반복 출력하는 프로그램</b></summary>
